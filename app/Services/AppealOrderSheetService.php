...
class AppealOrderSheetService
{
    ...
    public static function getAppealOrderSheetHeader($appealInfo){
         ...
         $header="<p class=\"form-bd\" style=\"text-align: left;\">বাংলাদেশ ফরম নম্বর -  ২৭০ <br>" . "</p>" .
            ...
            "        <p style=\"text-align: center;\">" .
             ...
             "জেলা :".$appealInfo['appeal']->district_name." , ".$banglaYear ." সালের ". DataConversionService::toBangla($noteLastDate) ." পর্যন্ত ।</span> <br><br><span style='float: left'> ".
    ...
    public static function getAppealOrderSheetTableContent($appealObjectFromUi,$orderNoBng,$trialDate){
        ...
        $userOffice = globalUserOfficeInfo();
        $signature ='';
        ...
        $tableContent="             <tr></tr><td valign=\"top\" align=\"center\">" .
           ...
           . DataConversionService::toBangla($trialDate) .
            ...
            "                            </td>" .
            "                            <td width=\"70%\" align=\"center\">" .
            "                                <span>".'<img style="width: 80px;" src="'.asset($user->signature).'" alt="signature"/>' ."</span>" .
            "                            </td>" .
            "                        </tr>" .
            "                        <tr>" .
            "                            <td width=\"30%\">" .
            "                            </td>" .
            "                            <td width=\"70%\" align=\"center\">" .
            "                                <span>".   '<br>'.'<b>'. $user->name .'</b>'.'<br> '.   $userRole->role_name  ."</span>" .
            "                            </td>" .
            "                        </tr>" .
            "                        <tr>" .
            "                            <td width=\"30%\">" .
            "                            </td>" .
            "                            <td width=\"70%\" align=\"center\">" .
            "                                <span>". $userOffice->office_name_bn."</span>" .
            "                            </td>" .
            "                        </tr>" .
            "                        </tbody>" .
            "                    </table>" .
            "                </td>".
            "<td style=\"padding:5px; font-size: 10px; text-align : center;\"><div><span>".'আদেশের উপর প্রয়োজনীয় ব্যবস্থা গ্রহণ করিলাম <p style=" font-size: 12px; color: blueviolet;"> সার্টিফিকেট সহকারী </p>'."</span></div></td>";
        return $tableContent;
    }
