...
class AppealInfoController extends AppealBaseController
{
...
//        return response()->json($causeList);
    ...
    public function getAppealOrderSheets(Request $request){
        $appealId=$request->appealId;
        $appealOrderLists=AppealOrderSheet::where('appeal_id',$appealId)->get();
        return response()->json([
