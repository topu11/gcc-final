...
class ReportController extends Controller
{
    ...
    public function pdf_generate(Request $request)
    {
      ...
      if($request->btnsubmit == 'pdf_num_district'){
         ...
         // Get Division
         $data['district'] = DB::table('district')->select('id', 'district_name_bn')->where('division_id', $request->division)->get();
    ...
    public function case_count_status_by_district($status, $id, $data){
      // dd($data);
      $query = DB::table('case_register')->where('district_id', $id)->where('status', $status);
      if($data['year']){
        $query->whereYear('case_date', '=', $data['year']);
      }
    ...
    public function case_count_status_by_upazila($status, $id, $data){
      // dd($data);
      $query = DB::table('case_register')->where('upazila_id', $id)->where('status', $status);
      if($data['year']){
        $query->whereYear('case_date', '=', $data['year']);
      }
    ...
    public function case_count_status_by_division_result_win($status, $id, $data){
      // dd($data);
      $query = DB::table('case_register')->where('division_id', $id)->where('in_favour_govt', 1)->where('status', $status);
      if($data['year']){
        $query->whereYear('case_date', '=', $data['year']);
      }
    ...
    public function case_count_status_by_division_result_lost($status, $id, $data){
      // dd($data);
      $query = DB::table('case_register')->where('division_id', $id)->where('in_favour_govt', 0)->where('status', $status);
      if($data['year']){
        $query->whereYear('case_date', '=', $data['year']);
      }
    ...
    public function case_count_status_by_district_result_win($status, $id, $data){
      // dd($data);
      $query = DB::table('case_register')->where('district_id', $id)->where('in_favour_govt', 1)->where('status', $status);
      if($data['year']){
        $query->whereYear('case_date', '=', $data['year']);
      }
    ...
    public function case_count_status_by_district_result_lost($status, $id, $data){
      // dd($data);
      $query = DB::table('case_register')->where('district_id', $id)->where('in_favour_govt', 0)->where('status', $status);
      if($data['year']){
        $query->whereYear('case_date', '=', $data['year']);
      }
    ...
    public function case_count_status_by_upazila_result_win($status, $id, $data){
      // dd($data);
      $query = DB::table('case_register')->where('upazila_id', $id)->where('in_favour_govt', 1)->where('status', $status);
      if($data['year']){
        $query->whereYear('case_date', '=', $data['year']);
      }
    ...
    public function case_count_status_by_upazila_result_lost($status, $id, $data){
      // dd($data);
      $query = DB::table('case_register')->where('upazila_id', $id)->where('in_favour_govt', 0)->where('status', $status);
      if($data['year']){
        $query->whereYear('case_date', '=', $data['year']);
      }
...
*/
    ...
    public function case_list_filter($data){
      ...
      // Query
      $query = DB::table('case_register')
      ->select('case_register.id', 'case_register.case_number', 'case_register.case_date', 'mouja.mouja_name_bn', 'district.district_name_bn', 'upazila.upazila_name_bn', 'case_register.case_date')
      ->join('district', 'case_register.district_id', '=', 'district.id')
      ->join('upazila', 'case_register.upazila_id', '=', 'upazila.id')
      ->join('mouja', 'case_register.mouja_id', '=', 'mouja.id')
      ->orderBy('id','DESC');
      // ->where('case_register.id', '=', 29);
      if($dateFrom != NULL && $dateTo != NULL){
       $query->whereBetween('case_register.case_date', [$dateFrom, $dateTo]);
     }
     if(!empty($data['division'])){
       $query->where('case_register.division_id', $data['division']);
     }
