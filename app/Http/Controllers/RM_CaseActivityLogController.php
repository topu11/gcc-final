...
class RM_CaseActivityLogController extends Controller
{
    public function index(Request $request)
    {
        ...
        $data['page_title'] = 'রাজস্ব মামলা কার্যকলাপ নিরীক্ষা';
        return view('rm_case.caseActivityLog.index')->with($data);
    ...
    public function show($id)
    {
        ...
        $data['rm_caseActivityLogs'] = RM_CaseActivityLog::where('rm_case_id', $id)->orderby('id', 'DESC')->get();


        $data['page_title'] = 'রাজস্ব মামলার কার্যকলাপ নিরীক্ষার বিস্তারিত তথ্য';
        // return $atcases;
        return view('rm_case.caseActivityLog.show')->with($data);
    }

    public function reg_case_details($id)
    {
        $data['rm_caseActivityLog'] = RM_CaseActivityLog::findOrFail($id);

        $data['page_title'] = 'নিরীক্ষা, রাজস্ব মামলার বিস্তারিত তথ্য ';
        return view('rm_case.caseActivityLog.caseDetails')->with($data);
    }
