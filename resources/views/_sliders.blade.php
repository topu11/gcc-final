...
<div class="slider">
    ...
    @foreach($big_news as $key => $row)
            ...
            <div class="card card-custom-news card_news_home mb-lg-0 p-5">
                <div class="card_news_item">
                    <div class="card_news_head mb-4">
                        <h3>{{ Str::limit($row->news_title,60) }}</h3>
                    </div>
                    <div class="card_news_body">
                        <p>{{ Str::limit($row->news_details, 250) }}</p>
                    </div>
                    <div class="card_news_bottom">
                         <div class="card_news_bottom_left">
                        ...
                        <div class="card_news_bottom_right">
                            <a href="{{ route('news.single',[ 'id'=>$row->id ]) }}" class="text-center text-hover-primary font-weight-bold">Read more... </a>
                        </div>
                    </div>
                </div>
            </div>
