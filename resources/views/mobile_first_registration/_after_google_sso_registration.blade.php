                    ...
                    <div class="card phomebutton_card" style="background: #f6f6f7 !important">
                        <div class="card-body phomebutton_cbody">
                            <div class="row text-center">
                                <div class="col-md-12">
                                  <h3 class="py-3">আপনার Gmail Account <span  class="fw-bold text-danger">{{ $results }}</span> এর জন্য নিবন্ধন </h3>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-8">
                                    <a href="{{ route('mobile.first.registration.opt.form',['role_id'=>encrypt(36)]) }}"><button class="btn btn-success btn-block"><i class="fas fa-users"></i> নাগরিক নিবন্ধন</button></a>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-8">
                                    <a href="{{ route('mobile.first.registration.opt.form',['role_id'=>encrypt(35)]) }}"><button class="btn btn-success btn-block"><i class="fas fa-user"></i> প্রাতিষ্ঠানিক  নিবন্ধন </button></a>
                                </div>
                            </div>
                        </div>
                    </div>
