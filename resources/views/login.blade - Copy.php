				...
				<div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
					...
					<div class="d-flex flex-column-auto flex-column pt-lg-10 pt-10">
						...
						<a href="#" class="text-center mb-10">
							...
							<img src="{{ asset(App\Models\SiteSetting::first()->fevicon) }}" class="max-h-70px" alt="" />
						</a>
						<!--end::Aside header-->
					</div>
					<!--end::Aside Top-->
				...
				<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
					...
					<form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label class="font-size-h6 font-weight-bolder text-dark col-md-4">Email</label>
                        ...
                        <div class="form-group row">
                            <label class="font-size-h6 font-weight-bolder text-dark pt-5 col-md-4">Password</label>
