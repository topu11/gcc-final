                    ...
                    <div class="card " style="background: #f6f6f7 !important">
                        <div class="card-body mt-15">
                            <div class="row text-center">
                                <div class="col-md-12">
                                  <h3 class="py-3">আপনার Gmail Account <span  class="fw-bold text-danger">{{ $results }}</span> এর জন্য প্রাতিষ্ঠানিক নিবন্ধন </h3>
                                </div>
                            </div>
                            ...
                            <br>
                            <form id="nidVerifyForm" action="{{ route('organization.nid_verify.google.sso') }}" class="form" method="POST"
