                    ...
                    <fieldset class=" mb-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 mb-5">
                                ...
                                <input type="text" name="case_type" class="form-control form-control-sm" placeholder="মামলার ধরণ " value="{{ $info->ct_id }}">
                            ...
                            <div class="col-lg-4 mb-5">
                                ...
                                <input type="text" name="case_no" class="form-control form-control-sm" placeholder="মামলা নং " value="{{ $info->case_number }}">
                            </div>
                            <div class="col-lg-4 mb-5">
                                <label>মামলা রুজুর তারিখ <span class="text-danger">*</span></label>
                                <input type="text" name="case_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->case_date }}">
                            </div>
                        </div>
                    </fieldset>
