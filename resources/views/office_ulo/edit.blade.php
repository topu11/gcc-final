...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form action="{{ route('ulo.update', $offices[0]->id) }}" class="form" method="post">
            @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                    	<div class="form-group col-lg-6">
				                <label for="mouja_name" class=" form-control-label">মৌজার নাম <span class="text-danger">*</span></label>
				                <input type="text" id="mouja_name" name="mouja_name" placeholder="অফিসের নাম লিখুন" class="form-control form-control-sm" value="{{ $offices[0]->mouja_name }}">
