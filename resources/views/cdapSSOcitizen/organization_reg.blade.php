    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <form action="{{ route('cdap.organizationRegister.store') }}" class="form" method="POST"
                    ...
                    <div class="card-body">
                       <div class="row">
                        <div class="col-md-12">
                            <img src="{{ $data_from_cdap['data']['photo'] }}" style="width: 150px">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-12 mb-5">
                                ...
                                <input type="text" name="name" id="name" class="form-control form-control-sm"
                                    value="{{ $data_from_cdap['data']['name'] }}" readonly>
                            </div>
                            <div class="col-lg-12 mb-5">
                            ...
                            <div class="col-lg-6 mb-5">
                                ...
                                <input type="date" name="dob" id="dob" class="form-control form-control-sm"
                                    value="{{ $data_from_cdap['data']['date_of_birth']  }}" readonly>
                            </div>
                            <div class="col-lg-6 mb-5">
                                ...
                                <select name="citizen_gender" id="citizen_gender" class="form-control form-control-sm"
                                    ...
                                    <option value="{{ strtoupper($data_from_cdap['data']['gender']) }}" {{ strtoupper($data_from_cdap['data']['gender'])== 'MALE' ? 'selected' : 'disabled' }}>
                                        পুরুষ
                                    </option>
                                    <option value="{{ strtoupper($data_from_cdap['data']['gender'])  }}" {{ strtoupper($data_from_cdap['data']['gender']) == 'FEMALE' ? 'selected' : 'disabled' }}>
                                        নারী
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-6 mb-5">
                                ...
                                <input type="email" name="email" id="email" class="form-control form-control-sm"
                                    placeholder="ই-মেইল "
                                    value="{{ $data_from_cdap['data']['email']  }}"
                                    readonly>
                            </div>
                            <div class="col-lg-12 mb-5">
                                ...
                                <div class="input-group" id="show_hide_password_organization_registation">
                                    <input type="text" name="citizen_nid" id="citizen_nid"
                                        class="form-control form-control-sm" value="{{ $data_from_cdap['data']['nid']  }}" readonly/>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                ...
                                <input type="text" name="father_name" id="father_name"
                                    class="form-control form-control-sm" placeholder="মোবাইল নম্বর" autocomplete="off"
                                    value="{{ $data_from_cdap['data']['father_name']  }}"
                                    readonly>
                            </div>
                            <div class="col-lg-6 mb-5">
                                ...
                                <input type="text" name="mother_name" id="mother_name" class="form-control form-control-sm"
                                    placeholder="ই-মেইল "
                                    value="{{ $data_from_cdap['data']['mother_name']  }}"
                                    readonly>
                            </div>
                            <div class="col-lg-12 mb-5">
                                ...
                                <textarea name="permanentAddress" id="permanentAddress" class="form-control form-control-sm common_datepicker"
                                    autocomplete="off" value="" readonly>{{ $data_from_cdap['data']['pre_address'] }}
								</textarea>
                            </div>
                            <div class="col-lg-12 mb-5">
                                ...
                                <textarea name="presentAddress" id="presentAddress" class="form-control form-control-sm common_datepicker"
                                    autocomplete="off" value="" readonly>{{ $data_from_cdap['data']['per_address'] }}
								</textarea>
