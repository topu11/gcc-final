        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 phomebuttons">
                    ...
                    @if(Session::has('cdap_nid_error'))
                    <div class="alert alert-danger">
                        {{ Session::get('cdap_nid_error') }}
                    </div>
                    @endif
                    <div class="card " style="background: #f6f6f7 !important">
                        <div class="card-body mt-15">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="pb-lg-0 pb-5 pt-8">
                                        <a href="{{ route('applicant.login.registration') }}"
                                            class="text-center btn btn-primary btn-block font-size-h6 px-8 py-4 my-3 mr-3"
                                            wait-class="spinner spinner-right spinner-white pr-15"></i>আবেদনকারী লগইন</a>
                                    </div>
                                    <div class="pb-lg-0 pb-5 pt-8">
                                        <a href="{{ route('nothi.v2.login') }}"
                                            class="text-center btn btn-success btn-block font-size-h6 px-8 py-4 my-3 mr-3"
                                            wait-class="spinner spinner-right spinner-white pr-15">প্রশাসনিক লগইন</a>
                                    </div>
                                    <div class="pb-lg-0 pb-5 pt-8">
                                        <a href="{{ route('google.sso.auth') }}"
                                            class="text-center btn btn-danger btn-block font-size-h6 px-8 py-4 my-3 mr-3"
                                            wait-class="spinner spinner-right spinner-white pr-15"><i
