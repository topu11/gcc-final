                        ...
                        <div class="card-body mt-15">
                            <div class="row">
                                ...
                                <h4 class="p-2 text-center" style="color: #fff;
                                    ...
                                    border-color: #008841;
                                    border-radius:5px
                                    "><i class="fas fa-users" style="color: #fff;"></i> প্রাতিষ্ঠানিক  নিবন্ধন</h4>
                                </div>
                                
                            </div>
                            <br>
                            <form id="nidVerifyForm" action="{{ route('organization.nid_verify') }}" class="form" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-2"></div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nid_no" id="nid_no" class="form-control form-control name-group" placeholder="উদাহরণ- 19825624603112948" value="{{ old('nid_no') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="dob"
                                                ...
                                                <input type="text" name="dob" id="dob" class="form-control  common_datepicker" placeholder="বছর/মাস/তারিখ" autocomplete="off" value="{{ old('dob') }}">
