               ...
               <div class=" col-12 row">
                  <div class="col-4">
                     <div class="form-group">
                         <label for="name" class=" form-control-label">পুরো নাম  অপরিবর্তনযোগ্য<span class="text-danger">*</span></label>
                         <input type="text" id="name" name="name" placeholder="পুরো নাম লিখুন" class="form-control form-control-sm"value="{{ $userManagement->name}}" readonly>
                         <div class="mt-2">সূত্র জাতীয় পরিচয়পত্র</div>
