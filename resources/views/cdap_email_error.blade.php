        ...
        <div class="container">
            ...
            <div class="py-5 text-center">
                <div class="alert alert-danger" role="alert">
                    আপনি একজন প্রাতিষ্ঠানিক প্রতিনিধি হিসেবে Gcc Court System এ Login করছেন আপনার ইমেইল (Email Address) টি আপনার MyGov / CDAP Account এ Verify করা নেই , Email Address Verify করতে নিচের Button এ Click করুন 
                  </div>
                  <a class="btn btn-primary" href="{{ $link }}" target="_blank" id="go_to_mygov">Click Here</a>

                  <a class="btn btn-primary" href="{{ route('cdap.user.create.organization')}}"  id="go_to_refresh" style="display:none">Refresh</a>
