<div class="row">
    <div class="col-xl-9">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-body">
                <div class="mr-0">
                    <div class="h4 pb-1"><i class="fa fas fa-hashtag text-success icon-md"></i>
                        <span class="font-weight-bolder">মামলা নং-</span> {{ $info->case_number }}
                    </div>
                    <div class="h4 pt-0"><i class="fa fas fa-map-marker-alt text-success icon-md ml-0 mr-1"></i>
                        <span class="font-weight-bolder">মামলার অবস্থানঃ</span> {{ $info->status_name }}
                    </div>
    ...
    <div class="col-xl-3">
        @if ($info->status != 3)
            <a href="javascript:void(0)" class="btn btn-success btn-shadow font-weight-bolder font-size-h1 px-12 py-4"
