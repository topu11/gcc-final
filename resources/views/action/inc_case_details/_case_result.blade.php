    <div class="container" id="caseResultUpdate">
        ...
        @if ($info->case_result_file != null)
            <div class="my-5">
                <span class="text-dark-100 flex-root font-weight-bolder h2">মামলার ফলাফলের দলিল :</span><br>
                <embed src="{{ asset('uploads/case_result_file/' . $info->case_result_file) }}" type="application/pdf" width="100%" height="600px" />
            </div>
        @endif
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="radio-inline">
                                                    <label class="radio">
                                                        ...
                                                        <span></span>জয়</label>
                                                    <label class="radio">
                                                        <input type="radio" name="is_win" id="lost" value="2" />
