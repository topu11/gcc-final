                        ...
                        <div class="row mb-8 ">
                            <div class="col-md-12">
                                <div class="example-preview">
                                    <ul class="nav nav-pills nav-fill bg-dark rounded">
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item mr-0">
                                            <a class="nav-link fw-bolder" id="regTab6" data-toggle="tab" href="#regTab_6">
                                                <span class="nav-icon">
                                                    <i class="flaticon2-chat-1"></i>
                                                </span>
                                                <span class="nav-text bold">পুলিশের তথ্য</span>
                                            </a>
                                        </li>
                                    </ul>
                                    <hr>
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select style="width: 100%;"
                                                                        ...
                                                                        <option value="FEMALE"  {{ $applicantCitizen->citizen_gender ?? '-' == 'FEMALE' ? 'selected' : ''}}>নারী</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="police[name]" id="policeName_1"
                                                                        class="form-control form-control-sm" value="{{ $policeCitizen->citizen_name ?? '-' }}">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="police[father]" id="policeFather_1"
                                                                        class="form-control form-control-sm" value="{{ $policeCitizen->father ?? '-' }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="police[designation]"
                                                                        ...
                                                                        class="form-control form-control-sm" value="{{ $policeCitizen->designation ?? '-' }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="police[nid]" id="policeNid_1"
                                                                        class="form-control form-control-sm" value="{{ $policeCitizen->citizen_NID ?? '-' }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="police[phn]" id="policePhn_1"
                                                                        class="form-control form-control-sm" value="{{ $policeCitizen->citizen_phone_no ?? '-' }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="police[email]" id="policeEmail_1"
                                                                        class="form-control form-control-sm" value="{{ $policeCitizen->email ?? '-' }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="police[thana]" id="policeThana_1"
                                                                        class="form-control form-control-sm" value="{{ $policeCitizen->thana_name ?? '-' }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input name="police[upazilla]" id="policeUpazilla_1"
                                                                        class="form-control form-control-sm" value="{{ $policeCitizen->upazilla_name ?? '-' }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
