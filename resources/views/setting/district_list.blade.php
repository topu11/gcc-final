   ...
   <div class="card-body">
      ...
      <table class="table table-hover mb-6 font-size-h6">
         ...
         <tbody>
            ...
            <?php
               if($row->status == 1){
                  $disStatus = '<span class="label label-inline label-light-primary font-weight-bold">এনাবল</span>';
               }else{
               	$disStatus = '<span class="label label-inline label-light-primary font-weight-bold">ডিসএবল</span>';
               }
            ?>
            <tr>
               ...
               <td><?=$disStatus?></td>
               <td>
                  <a href="{{ route('district.edit', $row->id) }}" class="btn btn-success btn-shadow btn-sm font-weight-bold pt-1 pb-1">সংশোধন</a>
               </td>
            </tr>
            @endforeach
         </tbody>
