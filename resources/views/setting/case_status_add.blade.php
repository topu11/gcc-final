...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            @endif
            <!--begin::Form-->
            <form action="{{ route('case-status.store') }}" class="form" method="POST">
            @csrf
                <div class="card-body row">
                    <div class="form-group col-lg-6">
                        <div class="form-group col-lg-6">
                            <label for="status_name" class=" form-control-label">স্ট্যাটাসের নাম <span class="text-danger">*</span></label>
                            <input type="text" id="status_name" name="status_name" placeholder="স্ট্যাটাসের নাম লিখুন" class="form-control form-control-sm">
                        ...
                        <div class="form-group col-lg-6">
                            ...
                            <textarea type="text" id="templete" name="templete" rows="10" placeholder="মন্তব্যের টেমপ্লেট লিখুন" class="form-control form-control-sm"></textarea>
                            <span style="color: red">
                                {{ $errors->first('name') }}
                            </span>
                        </div>
