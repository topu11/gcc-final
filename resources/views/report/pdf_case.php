			...
			<div class="priview-demand">
				<table class="table table-hover table-bordered report">
					<thead class="headding">
						<tr>
							<th class="text-left">বিচারাধীন</th>
							<td class="text-center"><?=en2bn($results['ON_TRIAL'])?></td>
						</tr>	
						<tr>	
							<th class="text-left">গ্রহণের জন্য অপেক্ষমান (জিসিও)</th>
							<td class="text-center"><?=en2bn($results['SEND_TO_GCO'])?></td>
						</tr>	
						<tr>	
							<th class="text-left">গ্রহণের জন্য অপেক্ষমান (সার্টিফিকেট সহকারী)</th>
							<td class="text-center"><?=en2bn($results['SEND_TO_ASST_GCO'])?></td>
						</tr>	
						<tr>	
							<th class="text-left">গ্রহণের জন্য অপেক্ষমান (জেলা প্রশাসক)</th>
							<td class="text-center"><?=en2bn($results['SEND_TO_DC'])?></td>
						</tr>	
						<tr>	
							<th class="text-left">গ্রহণের জন্য অপেক্ষমান (বিভাগীয় কমিশনার)</th>
							<td class="text-center"><?=en2bn($results['SEND_TO_DIV_COM'])?></td>
						</tr>	
						<tr>	
							<th class="text-left">গ্রহণের জন্য অপেক্ষমান (এলএবি চেয়ারম্যান)</th>
							<td class="text-center"><?=en2bn($results['SEND_TO_LAB_CM'])?></td>
						</tr>	
						<tr>	
							<th class="text-left">নিষ্পন্নকৃত</th>
							<td class="text-center"><?=en2bn($results['CLOSED'])?></td>
						</tr>	
