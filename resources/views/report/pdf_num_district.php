		...
		<div class="priview-demand">
			<table class="table table-hover table-bordered report">
                ...
                <tr>
							...
							<th class="text-center">বিচারাধীন</th>
							<th class="text-center">গ্রহণের জন্য অপেক্ষমান (জিসিও)</th>
							<th class="text-center">গ্রহণের জন্য অপেক্ষমান (সার্টিফিকেট সহকারী)</th>
							<th class="text-center">গ্রহণের জন্য অপেক্ষমান (জেলা প্রশাসক)</th>
							<th class="text-center">গ্রহণের জন্য অপেক্ষমান (বিভাগীয় কমিশনার)</th>
							<th class="text-center">গ্রহণের জন্য অপেক্ষমান (এলএবি চেয়ারম্যান)</th>
							<th class="text-center">নিষ্পন্নকৃত</th>
				...
				<tbody>
					...
					foreach ($results as $row) {
                        ...
                        <td class="text-center"><?=en2bn($i)?>.</td>
							...
							<td class="text-center"><?=en2bn($row['ON_TRIAL'])?></td>
							<td class="text-center"><?=en2bn($row['SEND_TO_GCO'])?></td>
							<td class="text-center"><?=en2bn($row['SEND_TO_ASST_GCO'])?></td>
							<td class="text-center"><?=en2bn($row['SEND_TO_DC'])?></td>
							<td class="text-center"><?=en2bn($row['SEND_TO_DIV_COM'])?></td>
							<td class="text-center"><?=en2bn($row['SEND_TO_LAB_CM'])?></td>
							<td class="text-center"><?=en2bn($row['CLOSED'])?></td>
