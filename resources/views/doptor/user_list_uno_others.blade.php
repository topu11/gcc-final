    ...
    <div class="card">
        ...
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h2> জেনারেল সার্টিফিকেট আদালতের ইউজার ম্যানেজমেন্ট,  উপজেলা নির্বাহী অফিসার (জেনারেল সার্টিফিকেট অফিসার) নির্বাচন </h2>
            </div>
            <div class="card-toolbar">
                <a href="{{ route('doptor.user.management.user_list.segmented.all', ['office_id' => encrypt($office_id)]) }}"
        ...
        <div class="card-body">
            ...
            <form class="form-inline" method="GET"
                action="{{ route('doptor.search.all.members', ['office_id' => encrypt($office_id)]) }}">
    ...
    <script>
        $('.court_select').on('change', function() {
            ...
            if (role_id == 27) {
                swal.showLoading();
                $.ajax({
                    url: '{{ route('doptor.user.management.store.gco.uno') }}',
                    method: 'post',
                    data: {
