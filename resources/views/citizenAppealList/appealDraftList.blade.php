                    ...
                    <td>
                        <div class="btn-group float-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{ route('citizen.appeal.appealView', encrypt($row->id)) }}">বিস্তারিত তথ্য</a><!-- 
                                <a class="dropdown-item" href="{{ route('appeal.nothiView', encrypt($row->id)) }}">নথি দেখুন</a> -->
                                @if ($row->appeal_status == 'DRAFT')
                                    <a class="dropdown-item" href="{{ route('citizen.appeal.edit', encrypt($row->id)) }}">সংশোধন করুন</a>
                                @endif
