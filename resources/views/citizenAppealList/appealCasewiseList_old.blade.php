    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9" id="rightBar">
                    ...
                    <div class="panel-body">
                        <form method="post" action="">
                            ...
                            <div class="row">
                                ...
                                {{--<div class="col-xs-12 {{ session('userRoleCode') == 'GCO_' ? 'col-sm-5':'col-sm-8' }}">--}}
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><strong class="panel-title">
                        @if(Route::is('closedList'))
                            @lang('message.Closed List')
                        @elseif(Route::is('postponedList'))
                            @lang('message.Postponed List')
                        @elseif(Route::is('transferList'))
                            @lang('message.Transfer List')
                        @elseif(Route::is('collectPaymentList'))
                            @lang('message.case') @lang('message.List')
                        @else
                            @lang('message.Appeal List')
                        @endif
