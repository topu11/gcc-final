            ...
            <div class="container">
                <!-- <a class="navbar-brand" href="{{ url('/') }}"> -->
                    {{-- {{ config('app.name', 'Laravel') }} --}}
                        <img class="img-responsive" src="{{ asset('images/ecourt.png') }}" alt="e-Court">
                    <h3 class="app-tag">
                        <p>{{ App\Models\SiteSetting::first()->name }}</p>
                        <!-- <small class="app-area">{{session('districtName')}} জেলা</small> -->
                    </h3>
                <!-- </a> -->
                        ...
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item text-white">
                                    <a class="nav-link"  style="color: white !important; font-weight: bold;" href="{{ route('login') }}">{{ __('লগইন') }}</a>
                                </li>
                            @endif
