    ...
    <div class="offcanvas-header offcanvas-header-navs d-flex align-items-center justify-content-between mb-5">
        <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-primary flex-grow-1 px-10" role="tablist">
            ...
            <li class="nav-item active">
                <a class="nav-link active" data-toggle="tab" href="#kt_quick_panel_notifications">নোটিফিকেশন</a>
            </li>
            <li class="nav-item d-none">
            ...
            <div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
                ...
                <div class="mb-5">
                    ...
                    {{-- <div class="d-flex align-items-center bg-light-success rounded p-5 mb-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">কারণ দর্শানোর নোটিশ রেজিস্টার এন্ট্রি</a>
                        </div>
                    ...
                    {{-- <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">নতুন মামলা</a>
                            <span class="text-muted font-size-sm">২৫</span>
                        </div>
                    ...
                    <div class="d-flex align-items-center bg-light-success rounded p-5 mb-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <a href="#" class="font-weight-normal text-dark-75 text-hover-primary font-size-lg mb-1">নতুন আপিল মামলা</a>
                            <span class="text-muted font-size-sm">৩</span>
                        </div>
                    ...
                    <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-5">
                        ...
                        <div class="d-flex flex-column flex-grow-1 mr-2">
                            <a href="#" class="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1">সম্পাদিত মামলা</a>
