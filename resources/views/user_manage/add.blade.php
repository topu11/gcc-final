				    ...
				    <div class="card-body card-block row">
				        ...
				        <div class="col-4">
				            <div class="form-group">
				                ...
				                <input type="text" id="username" name="username" placeholder="ইউজারনেম নাম লিখুন" class="form-control form-control-sm">
				                <span style="color: red">
			            ...
			            <div class="col-4">
			               	<div class="form-group">
			                    <label for="court_id" class=" form-control-label">আদালত <span class="text-danger">*</span></label>
			                    <select name="court_id" id="court_id" class="form-control-sm form-control">
			                    	<option value="">-- নির্বাচন করুন --</option>
		                                @foreach ($courts as $value)
		                                    <option value="{{ $value->id }}"> {{ $value->court_name }}, {{ $value->district_name_bn }} </option>
		                                @endforeach
			                    </select>
			                    <span style="color: red">
				      ...
				      <div class="modal-content">
				        ...
				        <div class="modal-body">
				           <table class="tg">
				                    ...
				                    <tr>
				                        <th class="tg-19u4 text-center">আদালত</th>
				                        <td class="tg-nluh" id="previewCourt_id"></td>
				                    </tr>
				                </table>
				        </div>
...
$('document').ready(function(){
	$('#preview').on('click',function(){
		...
		var court_id = $('#court_id option:selected').text();
