                    ...
                    <div class="card phomebutton_card" style="background: #f6f6f7 !important">
                        <div class="card-body phomebutton_cbody">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <a href="{{ url('/citizen/nid/check/google/sso') }}"><button class="btn btn-success btn-block"><i class="fas fa-users"></i> নাগরিক নিবন্ধন</button></a>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-2"></div>
                                <div class="col-md-8">
                                    <a href="{{ url('/organization/nid/check/google/sso') }}"><button class="btn btn-success btn-block"><i class="fas fa-user"></i> প্রাতিষ্ঠানিক  নিবন্ধন</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
