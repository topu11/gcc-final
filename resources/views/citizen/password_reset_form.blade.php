                    ...
                    <div class="card " style="background: #f6f6f7 !important">
                        <div class="card-body mt-15">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <button class="btn btn-success btn-block"><i class="fas fa-users"></i> পাসওয়ার্ড রিসেট
                                    </button>
                                </div>
                            </div>
                            <br>
                            <form id="nidVerifyForm" action="{{ route('user.check.forget.password') }}" class="form" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-2"></div>
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="mobile_number"
                                                class="control-label"><span
                                                    style="color:#FF0000">*
                                                </span> মোবাইল নাম্বার (ইংরেজিতে দিতে হবে) </label>
                                            <input type="text" name="mobile_number" id="mobile_number" class="form-control form-control name-group" placeholder="উদাহরণ- 01741315099">
                                        </div>
                                    </div>
                                    {{-- <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="dob"
                                                ...
                                                <input type="text" name="dob" id="dob" class="form-control  common_datepicker" placeholder="বছর/মাস/তারিখ" autocomplete="off" >
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="nid_no"
                                                class="control-label"><span
                                                    style="color:#FF0000">*
                                                </span> মোবাইল নং</label>
                                            <input type="text" name="mobile_number" id="nid_no" class="form-control form-control name-group" placeholder="+8801xxxxxxx">
                                        </div>
                                    </div>
                                    <!-- <textarea id="message" class="form-control" name="message" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="100" data-parsley-minlength-message="Come on! You need to enter at least a 20 character comment.." data-parsley-validation-threshold="10"></textarea> -->
                                </div> --}}
