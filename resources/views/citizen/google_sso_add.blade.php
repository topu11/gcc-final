        ...
        <div class="col-md-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input required type="text" {{-- id="applicantCiNID_1" --}} class="form-control check_nid_number"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input required type="text" id="defaulter_dob_input_smdn"
                                            placeholder="জন্ম তারিখ (জাতীয় পরিচয়পত্র অনুযায়ী) বছর/মাস/তারিখ" {{-- id="dob" --}}
                                            class="form-control common_datepicker" autocomplete="off">
                                        <input type="button" class="btn btn-primary check_nid_button" onclick="NIDCHECKDefaulter()"
                                            value="সন্ধান করুন">
                                    </div>
                                </div>
                            </div>
                ...
                <form action="{{ route('citizenRegister.store') }}" class="form" method="POST"
                    ...
                    <input type="hidden" value=" " name="father">
                    <input type="hidden" value=" " name="mother">

                    <div class="card-body">
                        <input type="hidden" name="citizen_nid" value="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 mb-5">
                                    ...
                                    <input type="email" name="email" id="email" value="{{ $results }}"
                                        class="form-control form-control-sm" placeholder="ই-মেইল" >
