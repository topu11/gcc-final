                        ...
                        <ul class="navi navi-border navi-hover navi-active">
                                ...
                                <a class="navi-link" href="#">
                                    ...
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">জেনারেল
                                            সার্টিফিকেট অফিসারের আদালতে বিচারাধীন মামলার সংখ্যা</span>
                                    </div>
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">জেলা প্রশাসকের
                                            আদালতে বিচারাধীন মামলার সংখ্যা</span>
                                    </div>
                                    <span class="navi-label">
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">বিভাগীয় কমিশনারের
                                            আদালতে বিচারাধীন মামলার সংখ্যা</span>
                                    </div>
                                    <span class="navi-label">
                                ...
                                <a class="navi-link" href="#">
                                    ...
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">সার্টিফিকেট
                                            অফিসারের গ্রহণের জন্য অপেক্ষমান মামলা </span>
                                    </div>
                                    <span class="navi-label">
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    ...
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">সার্টিফিকেট
                                            সহকারীর গ্রহণের জন্য অপেক্ষমান মামলা </span>
                                    </div>
                                    <span class="navi-label">
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">ডিসি মহোদয়ের
                                            গ্রহণের জন্য অপেক্ষমান মামলা</span>
                                    </div>
                                    <span class="navi-label">
                            ...
                            <li class="navi-item">
                                <a class="navi-link" href="#">
                                    <span class="navi-icon"><i class="fas fa-gavel icon-lg text-danger mr-3"></i></span>
                                    <div class="navi-text">
                                        <span class="d-block font-weight-bolder font-weight-bold h6 pt-2">নিষ্পত্তি
                                            মামলা</span>
                                    </div>
                                    <span class="navi-label">
