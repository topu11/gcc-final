        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form action="{{ url('case/save') }}" class="form" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-12 mb-5">
                            <fieldset>
                                ...
                                <table width="100%" border="1" id="surveyDiv" style="border:1px solid #dcd8d8;">
                                    <tr>
                                        <th>Type of the Survey <span class="text-danger">*</span></th>
                                        <th>Ledger no</th>
                                        <th>Daag No</th>
                                        <th>Land class</th>
                                        <th>Amount of land (percent)</th>
                                        <th>Amount of Complaint Land (Century)</th>
                                        <th width="50">
                    ...
                    <fieldset>
                        <legend>Chowhoddi details </legend>
                        <div class="col-lg-12 mb-5">
                            <label></label>
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6 mb-5">
                            <fieldset>
                                <legend>Show Cause letter scanned copy attachment <span class="text-danger">*</span></legend>
                                <div class="col-lg-12 mb-5">
