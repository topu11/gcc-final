...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form action="{{ url('case/old/update/'.$info->id) }}" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <fieldset class="mb-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 mb-5">
                                ...
                                <select name="gp_user_id" id="gp_user_id" class="form-control form-control-sm">
                                    ...
                                    <option value="{{ $value->id }}" {{ $value->id == $info->gp_user_id ? "selected" : ''}}> {{ $value->name }} </option>
                                    @endforeach
                                </select>
                            </div>
                            <!-- <div class="col-lg-3 mb-5">
                            ...
                            <div class="col-lg-3 mb-5">
                                ...
                                <input type="text" name="case_no" id="case_no" class="form-control form-control-sm" placeholder="মামলা নং " value="{{ $info->case_number }}">
                            </div>
                            <div class="col-lg-3 mb-5">
                                <label>মামলা রুজুর তারিখ <span class="text-danger">*</span></label>
                                <input type="text" name="case_date" id="case_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->case_date }}">
                            </div>
                            <div class="col-lg-3 mb-5">
                                 <label>ফলাফল</label>
                                 <div class="radio-inline">
                                    <label class="radio">
                                    <input type="radio" name="case_result" value="1" {{ ($info->case_result == "1")? "checked" : "" }}/>
                                    <span></span>জয়</label>
                                    <label class="radio">
                                    <input type="radio" name="case_result" value="0" {{ ($info->case_result == "0")? "checked" : "" }}/>
                                    <span></span>পরাজয়</label>
                                </div>
                            </div>
                            <div class="col-lg-3 mb-5">
                                <label>পরাজয়ের কারণ</label>
                                <textarea name="lost_reason" class="form-control" id="lost_reason" rows="2" spellcheck="false" value="{{ $info->lost_reason }}">{{ $info->lost_reason }}</textarea>
                            </div>
                            <div class="col-lg-3 mb-5">
                                 <label>মামলায় হেরে গিয়ে কি আপিল করা হয়েছে?</label>
                                <div class="radio-inline">
                                    <label class="radio">
                                    <input type="radio" name="is_lost_appeal" value="1" {{ ($info->is_lost_appeal == "1")? "checked" : "" }}/>
                                    <span></span>হ্যা</label>
                                    <label class="radio">
                                    <input type="radio" name="is_lost_appeal" value="0" {{ ($info->is_lost_appeal == "0")? "checked" : "" }}/>
                                    <span></span>না</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>তাফসিল</label>
                                    <textarea name="tafsil" class="form-control" id="tafsil" rows="3"  spellcheck="false"value="{{ $info->tafsil }}">{{ $info->tafsil }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>চৌহদ্দি</label>
                                    <textarea name="chowhaddi" class="form-control" id="chowhaddi" rows="3" spellcheck="false"value="{{ $info->chowhaddi }}">{{ $info->chowhaddi }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label>প্রাথিত প্রতিকার</label>
                                    <textarea name="treditional_remedies" class="form-control" id="traditional_remedies" rows="3" spellcheck="false"value="{{ $info->traditional_remedies }}">{{ $info->traditional_remedies }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="col-lg-6 mb-5">
                            <fieldset>
                                <legend>ফাইল আপলোড<span class="text-danger">*</span></legend>
                                <div class="col-lg-12 mb-5">
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label>কারণ দর্শাইবার নোটিশ প্রাপ্তির তারিখ</label>
                                            <input type="text" name="sc_receiving_date" id="sc_receiving_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->sc_receiving_date }}">
                                        </div>
                                        <label>কারণ দর্শাইবার স্ক্যান কপি সংযুক্তি </label>
                                        <div></div>
                                        <div class="custom-file">
                                        <input type="file" name="show_cause" class="custom-file-input" id="customFile" value="{{ $info->show_cause_file }}"/>
                                ...
                                <div class="col-lg-12 mb-5">
                                      <label>পাওয়ার অফ অ্যাটর্নি ফাইল সংযুক্তি </label>
                                        <div></div>
                                        <div class="custom-file">
                                            <input type="file" name="power_attorney_file" class="custom-file-input" id="customFile" value="{{ $info->power_attorney_file }}"/>
                                            <label class="custom-file-label" for="customFile">ফাইল নির্বাচন করুন</label>
                                        </div>
                                </div>
                                <div class="form-group">
                                    <label>কারণ দর্শাইবার আপিল নোটিশ প্রাপ্তির তারিখ</label>
                                        <div></div>
                                    <div class="form-group">
                                        <input type="text" name="send_date_rm_ac" id="send_date_rm_ac" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->send_date_rm_ac }}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div></div>
                                    <div class="custom-file">
                                        <input type="file" name="appeal_sc_file" class="custom-file-input" id="customFile" value="{{ $info->appeal_sc_file }}"/>
                                        <label class="custom-file-label" for="customFile">ফাইল নির্বাচন করুন</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div></div>
                                    <div class="custom-file">
                                        <input type="file" name="sf_report" class="custom-file-input" id="customFile" value="{{ $info->sf_report }}"/>
                                        <label class="custom-file-label" for="customFile">ফাইল নির্বাচন করুন</label>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 mb-5">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="send_date_ac_ulo" id="send_date_ac_ulo" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->send_date_ac_ulo }}">
                                </div>
                                <div class="form-group">
                                    <label>এস এফ ফাইল ইউ এল ও অফিস থেকে এসি ল্যান্ড অফিসে প্রেরণের তারিখ</label>
                                    <input type="text" name="send_date_sf_ulo_ac" id="send_date_sf_ulo_ac" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->send_date_sf_ulo_ac }}">
                                </div>
                                <div class="form-group">
                                    <label>এস এফ এর জবাব প্রাপ্তির তারিখ</label>
                                    <input type="text" name="send_date_ans_ac_rm" id="send_date_ans_ac_rm" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->send_date_ans_ac_rm }}">
                                </div>
                                <div class="form-group">
                                    <label>এফ এফ প্রতিবেদন চূড়ান্ত করার তারিখ</label>
                                    <input type="text" name="send_date_sf_rm_adc" id="send_date_sf_rm_adc" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->send_date_sf_rm_adc }}">
                                </div>
                            </fieldset>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 mb-5">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="order_date" id="order_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->order_date }}">
                                </div>
                                <div class="form-group">
                                    <label>পরবর্তী ধার্য তারিখ</label>
                                    <input type="text" name="next_assign_date" id="next_assign_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->next_assign_date }}">
                                </div>
                                <div class="form-group">
                                    <label>বিগত তারিখের আদেশ</label>
                                    <input type="text" name="past_order_date" id="past_order_date" class="form-control form-control-sm common_datepicker" placeholder="দিন/মাস/তারিখ" autocomplete="off" value="{{ $info->past_order_date }}">
                                </div>
                                <div class="col-lg-12 mb-5">
                                    <div class="form-group">
                                        ...
                                        <div></div>
                                        <div class="custom-file">
                                            <input type="file" name="order_file" class="custom-file-input" id="customFile" value="{{ $info->order_file }}"/>
                                            <label class="custom-file-label" for="customFile">ফাইল নির্বাচন করুন</label>
                                        </div>
                                    </div>
                                </div>
