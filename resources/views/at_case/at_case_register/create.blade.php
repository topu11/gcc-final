...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <!--begin::Form-->
            <form action="{{ route('atcase.store') }}" class="form" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <fieldset class="mb-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4 mb-5">
                                ...
                                <input type="text" name="sf_deadline" id="sf_deadline" class="form-control form-control-sm common_datepicker" placeholder="Date/Month/Year" autocomplete="off">
                            </div>
                            <div class="col-lg-4 mb-5">
                                ...
                                <select name="advocate" id="advocate_id" class="form-control form-control-sm">
                                    ...
                                    <option value="{{ $value->id }}" {{ old('advocate') == $value->id ? 'selected' : '' }}> {{ $value->name }} </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-lg-4 mb-5">
                                <label>Case Reason<span class="text-danger">*</span></label>
                                <textarea name="case_reason" class="form-control" id="case_reason" rows="2" spellcheck="false"></textarea>
                            </div>
                        </div>
                    </fieldset>
